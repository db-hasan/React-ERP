        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="col-md-10 ">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-end">
              <li class="nav-item">
                <Link class="nav-link" aria-current="page" to="/"> <i class="fa-solid fa-handshake-angle"></i> </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" aria-current="page" to="/"> <i class="fa-solid fa-clock"></i></Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link icons" aria-current="page" to="/"><i class="fa-solid fa-bell"></i> </Link>
              </li>
            </ul>
          </div>
          <div class="col-md-2">
