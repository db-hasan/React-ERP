                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                        <form className='row g-3' action="">
                                            ...
                                            <div class="col-md-6">
                                                <label for="Select" class="form-label">SubCategory</label>
                                                <select id="Select" class="form-select">
                                                    <option value="">Laptop</option>
                                                    <option value="">Phone</option>
                                                    <option value="">Monitor</option>
                                            ...
                                            <div class="col-md-4">
                                                <label for="Select" class="form-label">Unit</label>
                                                <select id="Select" class="form-select">
                                                    <option value="">Laptop</option>
                                                    <option value="">Phone</option>
                                                    <option value="">Monitor</option>
                                            ...
                                            <div class="mb-3">
                                                <label for="Select" class="form-label">Supplier Name</label>
                                                <select id="Select" class="form-select">
                                                    <option value="">Laptop</option>
                                                    <option value="">Phone</option>
                                                    <option value="">Monitor</option>
                                            ...
                                            <div class="col-md-6">
                                                <label for="exampleInputEmail1" class="form-label">Purchaes Price</label>
                                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                            </div>
                                            <div class="col-md-6">
