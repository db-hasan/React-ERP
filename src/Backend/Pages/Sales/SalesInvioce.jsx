         ...
         <>
            ...
            <div className="row rows">
                ...
                <div className="col-sm-8 col-md-9 col-lg-10 pt-2 px-3">
                    <div className='row'>
                        <div className='col'><h3>Sales Invioce</h3></div>
                        <div className='col text-end icons'>
                            <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                               <button className="btn btn-primary"><Link to="/SalesProduct" className="text-light"><i className="fa-solid fa-plus" /> Add New </Link></button>
                            </div>    
                        </div>                           
                    </div>
                        <hr />
                            ...
                            <table className="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href=""><i className="fa-solid fa-right-left fa-rotate-90 fa-sm" ></i></a> Customars</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="icons">
                                            ...
                                            <a href="" className="print" data-toggle="modal"><i class="fa-solid fa-print"></i></a>
