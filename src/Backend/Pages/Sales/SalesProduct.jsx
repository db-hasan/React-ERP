            ...
            <div className="row rows">
                ...
                <div className="col-sm-8 col-md-9 col-lg-10 ">
                    <div className='row pt-2 px-3'>
                        <div className='col'><h3>Sales Product</h3></div>
                        <div className='col text-end icons'>
                            <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                                <button className="btn btn-primary" ><Link to="/SalesInvioce" className="text-light"><i className="fa-solid fa-file-invoice" /> Invioce </Link></button>
                            </div>    
                        </div>                           
                    </div>
                    <hr />
