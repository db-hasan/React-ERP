                    ...
                    <div className='row'>
                        ...
                        <div className='col text-end icons'>
                            <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                                <button className="btn btn-primary" ><Link to="/PurchaesStockInvioce" className="text-light"><i className="fa-solid fa-file-invoice" /> Invioce </Link></button>
                            </div>    
                        </div>                           
                    </div>
                    <hr />
                        ...
                        <form className='row px-4' action="" method="post">
                                ...
                                <div className="row g-3 p-3">
                                    ...
                                    <div className="col-lg-12">
                                        <select id="inputState" className="form-select">
                                            <option value=""> From (Suppliers)</option>
                                        </select>
                                    </div>
                                    <div className="col-lg-12">
                                        <select id="inputState" className="form-select">
                                            <option value=""> To (Main Stock)</option>
                                        </select>
                                    </div>
                                    <div className="col-lg-12">
                            ...
                            <div className='col-lg-9'>
                                <div className="row g-3 p-3">
                                    ...
                                    <div className="col-2">
                                        <label for="inputAddress2" className="form-label"><strong>Total: 20</strong></label>
                                    </div>
